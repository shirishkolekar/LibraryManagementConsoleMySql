...
public class UserDAOImpl implements UserDAO {
	...
	public boolean addUser(User r) 
	{
		...
		try
		{
			...
			ps = con.prepareStatement("insert into table 		User	(readerName,address,contactNumber,email,registrationDate,roleId,pwd)values(?,?,?,?,?)");
	...
	{
		con = DbConnection.getCon();
		ps = con.prepareStatement("update User set getReaderName = ?,userStatus=?,contactNo=?,emailId=?,address=?,registrationDate=?,readerPassword=? where userId = ?");
